  ...
  return (
    <>
      <div className="grid grid-cols-12 items-center bg-white px-10 py-7 shadow-[0px_5px_10px_0px_rgba(0,_0,_0,_0.25)] rounded-lg">
        ...
        <div className="flex justify-center gap-3 col-span-8 lg:col-span-3 mt-5 lg:mt-0 text-[#A1A1AA]">
          <Calendar />
          <p>{formattedDate}</p>
        </div>
        <div className="col-span-4 lg:col-span-2 flex justify-end gap-5 text-[#A1A1AA]">
          {todo.status === "active" && (
            <SquarePen
